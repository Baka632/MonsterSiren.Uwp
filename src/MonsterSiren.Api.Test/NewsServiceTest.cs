...
public class NewsServiceTest
{
    ...
    public async void GetRecommendedNews()
    {
        ...
        IEnumerable<RecommendedNewsInfo> result = await NewsService.GetRecommendedNews();
    ...
    public async void GetNewsList()
    {
        ...
        ListPackage<NewsInfo> result = await NewsService.GetNewsList();
        ...
        ListPackage<NewsInfo> resultWithLastCid = await NewsService.GetNewsList(lastCid);
    ...
    public async void GetDetailedNewsInfo()
    {
        ...
        NewsDetail result = await NewsService.GetDetailedNewsInfo("605965");
