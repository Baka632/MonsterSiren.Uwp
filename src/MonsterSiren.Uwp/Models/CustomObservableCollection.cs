// Source: https://source.dot.net/#System.ObjectModel/System/Collections/ObjectModel/ObservableCollection.cs
...
public class CustomObservableCollection<T> : Collection<T>, INotifyCollectionChanged, INotifyPropertyChanged
{
    ...
    public CustomObservableCollection(IEnumerable<T> collection) : base(new List<T>(collection ?? throw new ArgumentNullException(nameof(collection))))
    {
    }

    public CustomObservableCollection(IList<T> list) : base(list ?? throw new ArgumentNullException(nameof(list)))
    {
    }
    ...
    protected void CheckReentrancy()
    {
        if (_blockReentrancyCount > 0)
        {
            ...
            if (CollectionChanged?.GetInvocationList().Length > 1)
                throw new InvalidOperationException("ObservableCollection reentrancy is not allowed");
        }
    }
