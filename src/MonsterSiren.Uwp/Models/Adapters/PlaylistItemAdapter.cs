...
public sealed class PlaylistItemAdapter(PlaylistItem playlistItem, Playlist sourcePlaylist) : ISongCidProvider, ICorruptible, IFavoriteAddable, INameProvider
{
    public string Name => playlistItem.SongTitle;
